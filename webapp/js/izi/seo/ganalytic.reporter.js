 ...
 * @version 	$Id: ganalytic.reporter.js 5082 2010-08-29 12:07:45Z hoangpt $
 * @since		2.0.7
 */

'Izi.Seo.Ganalytic.Reporter.js'.namespace();
 ...
 * @constructor
 */
Izi.Seo.Ganalytic.Reporter = function(id, data) {
	/**
 ...
 * Setters
 */
Izi.Seo.Ganalytic.Reporter.prototype.enableTooltip = function(enable) { this._enableTooltip = enable; };
Izi.Seo.Ganalytic.Reporter.prototype.setTooltipPattern = function(pattern) { this._tooltipPattern = pattern; };
Izi.Seo.Ganalytic.Reporter.prototype.setFormatDimensionCallback = function(callback) { this._formatDimensionCallback = callback; };
Izi.Seo.Ganalytic.Reporter.prototype.setFormatMetricCallback = function(callback) { this._formatMetricCallback = callback; };
 ...
 * @return void
 */
Izi.Seo.Ganalytic.Reporter.prototype.show = function() {
 ...
 * @return float
 */
Izi.Seo.Ganalytic.Reporter.prototype._getMaxMetric = function() {
