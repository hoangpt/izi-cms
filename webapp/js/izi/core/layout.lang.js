 ...
 * @version 	$Id: layout.lang.js 5082 2010-08-29 12:07:45Z hoangpt $
 * @since		2.0.0
 */

'Izi.Core.Layout.Lang'.namespace();
 ...
 * @constructor
 */
Izi.Core.Layout.Lang = function() {};

/** 
 * Language data 
 */
Izi.Core.Layout.Lang.DATA = {
 ...
 * @return void
 */
Izi.Core.Layout.Lang.setLang = function(data) {
	for (var p in data) {
		Izi.Core.Layout.Lang.DATA[p] = data[p];
	}
};
 ...
 * @return string
 */
Izi.Core.Layout.Lang.getLang = function(key) {
	return Izi.Core.Layout.Lang.DATA[key];
};
