 ...
 * @version 	$Id: zone.js 5082 2010-08-29 12:07:45Z hoangpt $
 * @since		2.0.0
 */

'Izi.Ad.Zone'.namespace();
 ...
 * @constructor
 */
Izi.Ad.Zone = function(id, name, width, height) {
	this._id 				 = id;
	this._name 				 = name;
	this._width 			 = width;
	this._height 			 = height;
	...
	this._mode 				 = Izi.Ad.Banner.UNIQUE_MODE;
};

Izi.Ad.Zone.prototype = {
	/**
	 * Getters/Setters
	 */
	...
	render: function() {
		...
		switch (this._mode) {
			case Izi.Ad.Banner.UNIQUE_MODE:
				var html = this._banners[0].render();
				$('#' + this._containerId).html(html);
				break;
			case Izi.Ad.Banner.SHARE_MODE:
				this._renderShareImageBanner();
				break;
			case Izi.Ad.Banner.ALTERNATE_MODE:
				var html = '';
				/**
