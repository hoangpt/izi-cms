 ...
 * @version 	$Id: banner.js 5082 2010-08-29 12:07:45Z hoangpt $
 * @since		2.0.0
 */

'Izi.Ad.Banner'.namespace();
 ...
 * @constructor
 */
Izi.Ad.Banner = function(id, zone, options, baseUrl) {
	 ...
	 */
	Izi.Ad.Banner.UNIQUE_MODE 	= 'unique';
	Izi.Ad.Banner.SHARE_MODE 	= 'share';
	Izi.Ad.Banner.ALTERNATE_MODE = 'alternate';
};

Izi.Ad.Banner.prototype = {
	/**
	 * Getters/Setters
	 */
	...
	render: function() {
		switch (this._options['format']) {
			case 'image':
				 ...
				 */
				if (Izi.Ad.Banner.ALTERNATE_MODE == this._options['mode']) {
