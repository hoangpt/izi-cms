 ...
 * @version 	$Id: Alexa.php 3526 2010-07-10 16:37:07Z hoangpt $
 * @since		2.0.7
 */

class Izi_Seo_Toolkit_Alexa extends Izi_Seo_Toolkit_Abstract
{
	...
	public function getBackLinksCount()
	{
	    ...
	    $data = Izi_Seo_Request::getResponse($url); 
	   	return 0;
	}
