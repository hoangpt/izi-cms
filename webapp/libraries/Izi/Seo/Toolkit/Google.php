 ...
 * @version 	$Id: Google.php 3546 2010-07-11 07:42:17Z hoangpt $
 * @since		2.0.7
 */
 ...
 */
class Izi_Seo_Toolkit_Google extends Izi_Seo_Toolkit_Abstract
{
	/**
	...
	public function getBackLinksCount()
	{
		...
		$content = Izi_Seo_Request::getResponse($url);
