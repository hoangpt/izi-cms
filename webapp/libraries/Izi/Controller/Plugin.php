 ...
 * @version 	$Id: Plugin.php 4722 2010-08-18 03:29:06Z hoangpt $
 * @since		2.0.0
 */

abstract class Izi_Controller_Plugin extends Zend_Controller_Plugin_Abstract 
{
	/**
	...
	public function __construct() 
	{
		...
		$file = IZI_APP_DIR . DS . str_replace('_', DS, $dir) . DS . 'config.xml';
		if (!file_exists($file)) {
			return;
		}
