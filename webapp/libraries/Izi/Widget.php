 ...
 * @version 	$Id: Widget.php 4636 2010-08-15 09:52:47Z hoangpt $
 * @since		2.0.0
 */

abstract class Izi_Widget 
{
	/**
	 * @const string
	 * @since 2.0.3
	 */
	const CURRENT_WIDGET_KEY = 'Izi_Widget_CurrentWidgetKey';
	...
	public function __construct($module, $name) 
	{
		...
		$this->_view->addHelperPath(IZI_APP_DIR . DS . 'modules' . DS . $this->_module . DS . 'views' . DS . 'helpers', 
									$this->_module.'_View_Helper_');
		$this->_view->addHelperPath(IZI_APP_DIR . DS . 'modules' . DS . $this->_module . DS . 'widgets' . DS . $this->_name, 
	...
	public function __call($name, $arguments) 
	{
		...
		$template = Zend_Registry::get(Izi_GlobalKey::APP_TEMPLATE);
		$path1 	  = IZI_APP_DIR . DS . 'modules' . DS . $this->_module . DS . 'widgets' . DS . $this->_name;
		$path2 	  = IZI_APP_DIR . DS . 'templates' . DS . $template . DS . 'views' . DS . $this->_module . DS . 'widgets' . DS . $this->_name;
