 ...
 * @version 	$Id: ImageMagick.php 3986 2010-07-25 16:32:46Z hoangpt $
 * @since		2.0.0
 */

class Izi_Image_ImageMagick extends Izi_Image_Abstract
{
	...
	public function flip($newFile, $mode)
	{
		...
		switch ($mode) {
			case Izi_Image_Abstract::FLIP_VERTICAL:
				$imagick->flipImage();
				break;
			case Izi_Image_Abstract::FLIP_HORIZONTAL:
				$imagick->flopImage();
				break;
		}
