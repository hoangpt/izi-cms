 ...
 * @version 	$Id: Widget.php 4637 2010-08-15 09:53:41Z hoangpt $
 * @since		2.0.0
 */

class Izi_View_Helper_Widget extends Zend_View_Helper_Abstract 
{
	private $_translationDao;
	
	public function __construct()
	{
		$this->_translationDao = Izi_Model_Dao_Factory::getInstance()->setModule('core')->getTranslationDao();
	}
	...
	public function widget($module, $name, array $params = array()) 
	{
		...
		$timeout = isset($params[Izi_Widget::PARAM_CACHE_LIFETIME]) 
					? $params[Izi_Widget::PARAM_CACHE_LIFETIME] 
					: null;
		 ...
		 * @since 2.0.8 
		 */
		$aboutFile = IZI_APP_DIR . DS . 'modules' . DS . $module . DS . 'widgets' . DS . $name . DS . 'about.xml';
