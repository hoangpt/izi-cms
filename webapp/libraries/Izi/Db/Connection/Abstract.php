 ...
 * @version 	$Id: Abstract.php 3762 2010-07-17 12:25:01Z hoangpt $
 * @since		2.0.5
 */

abstract class Izi_Db_Connection_Abstract
{
	const KEY 		 = 'Izi_Db_Connection_Abstract_Key';
	const PREFIX_KEY = 'Izi_Db_Connection_Abstract_TablePrefix';
