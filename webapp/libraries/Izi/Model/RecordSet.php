 ...
 * @version 	$Id: RecordSet.php 3986 2010-07-25 16:32:46Z hoangpt $
 * @since		2.0.0
 */

class Izi_Model_RecordSet implements Countable, Iterator, ArrayAccess 
{
	/**
	 * @var int
	 */
...
//		if (get_class($result) != $this->_entityClass) {
			...
			// Commented on Feb 3rd, 2010 by hoangpt
