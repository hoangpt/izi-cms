 ...
 * @version 	$Id: Resource.php 3986 2010-07-25 16:32:46Z hoangpt $
 * @since		2.0.0
 */

class Izi_Widget_Resource 
{
	public static function getResources($module, $widget) 
	{
		$ret  = array('javascript' => array(), 'css' => array());
		$file = IZI_APP_DIR . DS . 'modules' . DS . $module . DS . 'widgets' . DS . $widget . DS . 'about.xml';
		if (!file_exists($file)) {
			return $ret;
		}
