 ...
 * @version 	$Id: Loader.php 3986 2010-07-25 16:32:46Z hoangpt $
 * @since		2.0.0
 */

class Izi_Module_Loader 
{
	/**
	 * @var Izi_Module_Loader
	 */
	...
	{
		return Izi_Utility_File::getSubDir(IZI_APP_DIR . DS . 'modules');
	}
	...
	{
		$dir = IZI_APP_DIR . DS . 'modules' . DS . $moduleName . DS . 'config' . DS . 'routes';
		if (!is_dir($dir)) {
			return array();
		}
