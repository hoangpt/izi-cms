 ...
 * @version 	$Id: Widget.php 5073 2010-08-29 05:52:05Z hoangpt $
 * @since		2.0.0
 */

class Utility_Widgets_Twitter_Widget extends Izi_Widget 
{
	protected function _prepareShow() 
	{
    	...
    	$updates = Izi_Utility_HttpRequest::getResponse($url);
