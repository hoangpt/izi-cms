 ...
 * @version 	$Id: GwebmasterController.php 4823 2010-08-24 07:04:49Z hoangpt $
 * @since		2.0.7
 */
...
class Seo_GwebmasterController extends Zend_Controller_Action
{
	...
	public function init()
	{
		...
		if (!isset($_SESSION[self::GOOGLE_AUTH_SUB_TOKEN]) || !isset($_SESSION[self::GOOGLE_CLIENT_LOGIN_TOKEN])) {
			/**
		 	 ...
		 	 */
			$config = Izi_Module_Config::getConfig('seo');
	...
	public function detailsAction()
	{
		 ...
		 */
		$currentUrl   = Izi_Config::getConfig()->web->url->base;
		...
		if ($request->isPost()) {
			...
			switch ($method) {
				...
				case 'metatag':
					 ...
					 */
					$file   = IZI_APP_DIR . DS . 'modules' . DS . 'seo' . DS . 'config' . DS . 'config.ini';
