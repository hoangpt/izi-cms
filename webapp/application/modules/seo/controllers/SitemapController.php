 ...
 * @version 	$Id: SitemapController.php 3977 2010-07-25 11:32:32Z hoangpt $
 * @since		2.0.7
 */
...
class Seo_SitemapController extends Zend_Controller_Action
{
	...
	public function addAction()
	{
		...
		if ($request->isPost()) {
			...
			$item = new Izi_Seo_Sitemap_Item($loc, $changefreq, $priority);
			$file = IZI_ROOT_DIR . DS . 'sitemap.xml';
			Izi_Seo_Sitemap::addToSitemap($file, $item);
	...
	public function deleteAction() 
	{
		...
		if ($request->isPost()) {
			...
			if (count($urls) > 0) {
				$file  = IZI_ROOT_DIR . DS . 'sitemap.xml';
				$items = Izi_Seo_Sitemap::getItems($file);
				...
				Izi_Seo_Sitemap::save($file, $items);
			}
