 ...
 * @version 	$Id: QuestionController.php 4930 2010-08-25 03:38:40Z hoangpt $
 * @since		2.0.0
 */
...
class Poll_QuestionController extends Zend_Controller_Action 
{
	...
	public function listAction() 
	{
		 ...
		 * Paginator
		 */
		$paginator = new Zend_Paginator(new Izi_Utility_PaginatorAdapter($questions, $numQuestions));
