 ...
 * @version 	$Id: BannerController.php 4534 2010-08-12 09:50:52Z hoangpt $
 * @since		2.0.0
 */
...
class Ad_BannerController extends Zend_Controller_Action 
{
	...
	public function activateAction()
	{
		...
		if ($request->isPost()) {
			...
			$bannerDao = Izi_Model_Dao_Factory::getInstance()->setModule('ad')->getBannerDao();
	...
	public function addAction() 
	{
		...
		$zoneDao 	   = Izi_Model_Dao_Factory::getInstance()->setModule('ad')->getZoneDao();
		$clientDao 	   = Izi_Model_Dao_Factory::getInstance()->setModule('ad')->getClientDao();
		$bannerDao 	   = Izi_Model_Dao_Factory::getInstance()->setModule('ad')->getBannerDao();
		$bannerPageDao = Izi_Model_Dao_Factory::getInstance()->setModule('ad')->getBannerPageAssocDao();
	...
	public function listAction()
	{
		 ...
		 * Paginator
		 */
		$paginator = new Zend_Paginator(new Izi_Utility_PaginatorAdapter($banners, $numBanners));
