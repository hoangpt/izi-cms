 ...
 * @version 	$Id: Template.php 5029 2010-08-28 17:02:10Z hoangpt $
 * @since		2.0.5
 */

class Core_Models_Dao_Pdo_Mysql_Template extends Izi_Model_Dao
	implements Core_Models_Interface_Template
{
	...
	public function install($template)
	{
		 ...
		 */
		$file = IZI_APP_DIR . DS . 'templates' . DS . $template . DS . 'about.xml';
		if (!file_exists($file)) {
			return;
		}
