 ...
 * @version 	$Id: LinkProvider.php 4579 2010-08-12 19:13:03Z hoangpt $
 * @since		2.0.7
 */
...
class Core_Services_LinkProvider
{
	...
	public static function getLinks($lang = null)
	{
		...
		if (null == $lang) {
			$lang = Izi_Config::getConfig()->web->lang;
		}
		...
		$links = Izi_Hook_Registry::getInstance()->executeFilter('Core_LinkProvider', $links, array($lang));
