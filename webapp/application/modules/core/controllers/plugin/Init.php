 ...
 * @version 	$Id: Init.php 5023 2010-08-28 09:36:48Z hoangpt $
 * @since		2.0.0
 */
...
class Core_Controllers_Plugin_Init extends Zend_Controller_Plugin_Abstract 
{
	public function preDispatch(Zend_Controller_Request_Abstract $request) 
	{
		...
		$view->addHelperPath(IZI_LIB_DIR . DS . 'Izi' . DS . 'View' . DS . 'Helper', 'Izi_View_Helper');
		$view->addHelperPath(IZI_APP_DIR . DS . 'modules' . DS . 'core' . DS . 'views' . DS . 'helpers', 'Core_View_Helper');
		...
		$template = (!Zend_Registry::isRegistered(Izi_GlobalKey::APP_TEMPLATE) 
						|| Zend_Registry::get(Izi_GlobalKey::APP_TEMPLATE) == null 
						|| Zend_Registry::get(Izi_GlobalKey::APP_TEMPLATE) == '')
				? $config->web->template : Zend_Registry::get(Izi_GlobalKey::APP_TEMPLATE);
		Zend_Registry::set(Izi_GlobalKey::APP_TEMPLATE, $template);
		 ...
		 * Set layout
		 */
		Zend_Layout::startMvc(array('layoutPath' => IZI_APP_DIR . DS . 'templates' . DS . $template . DS . 'layouts'));
