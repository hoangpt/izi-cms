 ...
 * @version 	$Id: MessageController.php 4107 2010-07-29 11:11:47Z hoangpt $
 * @since		2.0.3
 */
...
class Core_MessageController extends Zend_Controller_Action 
{
	...
	public function errorAction()
	{
        ...
        if (isset($config->install->version)) {
			...
			$logDao = Izi_Model_Dao_Factory::getInstance()->setModule('core')->getLogDao();
