 ...
 * @version 	$Id: MailController.php 4522 2010-08-12 09:38:16Z hoangpt $
 * @since		2.0.6
 */
...
class Mail_MailController extends Zend_Controller_Action
{
	...
	public function listAction()
	{
		...
		$mailDao = Izi_Model_Dao_Factory::getInstance()->setModule('mail')->getMailDao();
		 ...
		 * Paginator
		 */
		$paginator = new Zend_Paginator(new Izi_Utility_PaginatorAdapter($mails, $numMails));
	...
	public function sendAction()
	{
		...
		$roleDao     = Izi_Model_Dao_Factory::getInstance()->setModule('core')->getRoleDao();
