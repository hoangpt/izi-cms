 ...
 * @version 	$Id: Widget.php 5248 2010-08-31 08:29:04Z hoangpt $
 * @since		2.0.0
 */

class News_Widgets_Newer_Widget extends Izi_Widget 
{
	protected function _prepareShow() 
	{
		...
		$dao = Izi_Model_Dao_Factory::getInstance()->setWidget($this)->getArticleDao();
