 ...
 * @version 	$Id: Widget.php 4714 2010-08-17 02:32:22Z hoangpt $
 * @since		2.0.0
 */

class News_Widgets_MostViewed_Widget extends Izi_Widget 
{
	protected function _prepareShow() 
	{
		...
		$articleDao = Izi_Model_Dao_Factory::getInstance()->setWidget($this)->getArticleDao();
